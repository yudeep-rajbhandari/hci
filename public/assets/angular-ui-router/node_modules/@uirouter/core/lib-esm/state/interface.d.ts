...
export interface StateDeclaration {
     ...
     * - What is a ui-view
     * - Shorthand controller/templates
     * - Incompatible with ^
     *
     *  Examples:
     *
     *  Targets three named ui-views in the parent state's templates
     *
     * #### Example:
     * ```js
     * views: {
     ...
     * @example
     * ```js
     * // Targets named ui-view="header" from ancestor state 'top''s templates, and
     * // named `ui-view="body" from parent state's templates.
     * views: {
     *   'header@top': {
