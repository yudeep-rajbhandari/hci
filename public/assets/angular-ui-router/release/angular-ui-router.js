...
function uiViewString(viewData) {
    ...
    return "[ui-view#" + viewData.id + " tag " +
        ("in templates from '" + (viewData.creationContext && viewData.creationContext.name || '(root)') + "' state]: ") +
        ("fqn: '" + viewData.fqn + "', ") +
...
var Transition = (function () {
     ...
     *
     * Each state can define one or more views (templates/controller), which are encapsulated as `ViewConfig` objects.
...
var UrlRouter = (function () {
     ...
     * ```
     *
     * @param urlMatcher The [[UrlMatcher]] object which is used as the templates of the URL to generate.
...
function ng1ViewsBuilder(state) {
    ...
    forEach(viewsObject, function (config, name) {
        ...
        // Do not allow a view to mix props for component-style view with props for templates/controller-style view
...
var Ng1ViewConfig = (function () {
    ...
    Ng1ViewConfig.prototype.load = function () {
        ...
        return $q$$1.all(promises).then(function (results) {
            ...
            extend(_this, results.template); // Either { templates: "tpl" } or { component: "cmpName" }
            return _this;
        });
    };
    /**
...
var TemplateFactory = (function () {
     ...
     *
     * @param template html templates as a string or function that returns an html templates as a string.
     * @param params Parameters to pass to the templates function.
     *
    ...
    TemplateFactory.prototype.makeComponentTemplate = function (uiView, context, component, bindings) {
        ...
        var attributeTpl = function (input) {
            ...
            // then pass that attribute through to the routed component templates.
 ...
 * can be customized using [[Ng1ViewDeclaration.resolveAs]]).  This can be then accessed from the templates.
 *
 ...
 * ```js
 * $stateProvider.state('home', {
 *   templates: '<my-component user="$resolve.user"></my-component>',
 *   resolve: {
